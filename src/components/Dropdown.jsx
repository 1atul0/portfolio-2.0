...
function Dropdown() {
  ...
  const svgs = [
    <svg
      className={"fill-gray-400 inline w-6 h-6   group-hover:fill-red-500  "+(activeButton===0?"fill-red-500":"")}
    ...
    <svg
    className={"fill-gray-400 inline w-6 h-6   group-hover:fill-red-500  "+(activeButton===1?"fill-red-500":"")}
      xmlns="http://www.w3.org/2000/svg"
      height="1em"
      viewBox="0 0 384 512"
    >
    ...
    <svg
    className={"fill-gray-400 inline w-6 h-6   group-hover:fill-red-500  "+(activeButton===2?"fill-red-500":"")}
      xmlns="http://www.w3.org/2000/svg"
      height="1em"
      viewBox="0 0 576 512"
    >
    ...
    <svg
    className={"fill-gray-400 inline w-6 h-6   group-hover:fill-red-500  "+(activeButton===3?"fill-red-500":"")}
      xmlns="http://www.w3.org/2000/svg"
      height="1em"
      viewBox="0 0 512 512"
    >
    ...
    <svg
    className={"fill-gray-400 inline w-6 h-6   group-hover:fill-red-500  "+(activeButton===4?"fill-red-500":"")}
      xmlns="http://www.w3.org/2000/svg"
      height="1em"
      viewBox="0 0 512 512"
    >
  ...
  return (
    <div className=" xl:hidden">
      ...
      {isOpen && (
        <div
          id="dropdown"
          className="absolute right-0 md:right-5  mt-10  w-11/12  bg-white border rounded-lg shadow-lg mx-5 
        transition duration-1000 ease-out origin-top min-w-32 text-md font-semibold "
        >
